<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Addcourse.aspx.cs" Inherits="Labfootball.Addcourse" %>
        ...
        <div class="row">
            <div class="col-md-6 mx-auto">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="body_CourseTermDropDownList">Term</label>
